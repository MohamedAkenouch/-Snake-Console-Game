...
//on refait la meme chose que le thread 1 , mais dans ce cas le snake se deplace vers le bas 
public class thread5 extends Thread{
    public void run(Snake snake ,GameScreen screen,Fruit fruit,ArrayList<Integer> snake_body_X,ArrayList<Integer> snake_body_Y) throws NullPointerException,InterruptedException {
        ...
        snake.moveDown(screen, snake, Main.snake_body_X, Main.snake_body_Y);
        Thread.sleep(500);
        screen.PrintScreen();
